...
import BorrowedBooksPage from '../layout/BorrowedBooksPage';
import {
    AppBar,
    Box,
    Toolbar,
...
import RequestPage from '../book/RequestPage';
    ...
    return (
        <>
           ...
           <Routes>
               ...
               />
               <Route
                   path="/books/:bookIsbn/request"
                   element={
                       <WithLoginProtector>
                           <RequestPage /> {/* Render the new empty page */}
                       </WithLoginProtector>
                   }
               />
               <Route
               ...
               />
               <Route path="/admin/books/borrowed" element={<BorrowedBooksPage />} />
